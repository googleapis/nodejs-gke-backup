...
describe('v1.BackupForGKEClient', () => {
    ...
    describe('getBackupPlan', () => {
        it('invokes getBackupPlan without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetBackupPlanRequest', ['name']);
    ...
    describe('getVolumeBackup', () => {
        it('invokes getVolumeBackup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetVolumeBackupRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getRestorePlan', () => {
        it('invokes getRestorePlan without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetRestorePlanRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getRestore', () => {
        it('invokes getRestore without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetRestoreRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getVolumeRestore', () => {
        it('invokes getVolumeRestore without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetVolumeRestoreRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createBackupPlan', () => {
        it('invokes createBackupPlan without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateBackupPlanRequest', ['parent']);
    ...
    describe('updateBackupPlan', () => {
        it('invokes updateBackupPlan without error', async () => {
            ...
            request.backupPlan ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateBackupPlanRequest', ['backupPlan', 'name']);
    ...
    describe('deleteBackupPlan', () => {
        it('invokes deleteBackupPlan without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteBackupPlanRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createRestorePlan', () => {
        it('invokes createRestorePlan without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateRestorePlanRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('updateRestorePlan', () => {
        it('invokes updateRestorePlan without error', async () => {
            ...
            request.restorePlan ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateRestorePlanRequest', ['restorePlan', 'name']);
    ...
    describe('deleteRestorePlan', () => {
        it('invokes deleteRestorePlan without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteRestorePlanRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createRestore', () => {
        it('invokes createRestore without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateRestoreRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('updateRestore', () => {
        it('invokes updateRestore without error', async () => {
            ...
            request.restore ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateRestoreRequest', ['restore', 'name']);
    ...
    describe('deleteRestore', () => {
        it('invokes deleteRestore without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteRestoreRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listBackupPlans', () => {
        it('invokes listBackupPlans without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListBackupPlansRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listVolumeBackups', () => {
        it('invokes listVolumeBackups without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListVolumeBackupsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('listRestorePlans', () => {
        it('invokes listRestorePlans without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListRestorePlansRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('listRestores', () => {
        it('invokes listRestores without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListRestoresRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('listVolumeRestores', () => {
        it('invokes listVolumeRestores without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListVolumeRestoresRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
